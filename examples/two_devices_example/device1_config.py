...
CHIP_SELECT_GPIOS_INITIALIZE: tuple[int, ...] = (7, 8)
...
RESET_PIN: int = 3  # Set to None if not used.
# Optional power down pin
PDWN_PIN: int = 2  # Set to None if not used.
###############################################################################
...
# REG_ADCON:
# Enable CLKOUT as the second chip is connected to this,
# sensor detect current sources disabled, gain setting as defined above:
adcon = CLKOUT_EQUAL | SDCS_OFF | gain_flags
# REG_DRATE:
# 10 SPS places a filter zero at 50 Hz and 60 Hz for line noise rejection
drate = DRATE_10
# REG_IO: No GPIOs needed
